...
const localizedUk = {
  ...
  landing: {
    ...
    story: {
      eyebrow: 'Обмін у русі',
      title: 'Книга рухається й памʼятає шлях.',
      description:
        'Простежте один фізичний примірник: від додавання в каталог до тимчасового обміну, передачі й повернення.',
      visualLabel: 'Візуалізація обміну процедурною книгою',
      stagesLabel: 'Етапи scroll-історії',
      assistiveListLabel: 'Етапи історії Book Exchange',
      progressLabel: 'Поточний етап',
      fallbackTitle: 'Історія обміну залишається читабельною.',
      fallbackDescription:
        'Статична версія зберігає ті самі чотири рухи книги, коли анімація недоступна.',
      fallbackReasons: {
        reducedMotion:
          'Увімкнено зменшення руху, тому історія показана статично.',
        webgl:
          'WebGL недоступний у цьому браузері, тому показано статичну книжкову сцену.',
        weakDevice:
          'Для стабільності на цьому пристрої використовується легша статична історія.',
        loading: 'Завантаження процедурної книжкової сцени.',
        error:
          'Анімовану сцену не вдалося завантажити, тому показано статичну історію.',
        notMounted: 'Анімована сцена завантажиться, коли розділ потрапить у поле зору.',
      },
      stages: {
        add: {
          title: 'Додати',
          description:
            'Книга піднімається з каталогу й розкривається, коли власник додає примірник на полицю.',
        },
        share: {
          title: 'Поділитися',
          description:
            'Тимчасова копія рухається до іншого читача, а початковий запис лишається у власника.',
        },
        give: {
          title: 'Передати',
          description:
            'Фізична книга переходить до власника B, коли обмін стає постійним.',
        },
        return: {
          title: 'Повернути',
          description:
            'Книга повертається до власника A, закривається, і обмін завершується.',
        },
      },
    },
    workflow: {
